...
export const ADMIN_EMAIL = "jc1725@gmail.com";

export function isAdminEmail(email: string | null | undefined) {
  return email?.trim().toLowerCase() === ADMIN_EMAIL;
}

export function isAdminUser<T extends { email: string | null | undefined; role: "user" | "admin" }>(user: T | null | undefined): user is T {
