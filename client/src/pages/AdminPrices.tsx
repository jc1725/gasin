...
export default function AdminPrices() {
  ...
  return <section>
    ...
    {deferredPageItems.map(product => {
      ...
      // 2026-09-22: 가신이 직접 조립한 쿠팡 주소로 접속하면 쿠팡 계정 접속이 막혀서,
      // 관리자 "쿠팡 상품 바로가기"도 딥링크로만 연다. 딥링크가 없으면 버튼이 비활성화된다.
      const coupangProductPageUrl = product.deepLinkUrl ?? null;
